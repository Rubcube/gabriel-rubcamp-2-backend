...
import { PrismaUserRepository } from 'modules/identity/repositories/PrismaUserRepository'

import { IAccountRepository } from 'modules/identity/domain/account/IAccountRepository'
import { PrismaAccountRepository } from 'modules/identity/repositories/PrismaAccountRepository'
